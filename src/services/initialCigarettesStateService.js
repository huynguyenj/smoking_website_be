...
const getInitialCigaretteInfoPaginationService = async (id, limit, page, sort, filter) => {
  try {
    const paginationData = await initialCigarette.getInitialStatePagination(id, limit, page, sort, filter)
