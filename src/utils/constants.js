...
export const COOKIES_OPTIONS = {
  ...
  sameSite: env.BUILD_MODE === 'production' ? 'none' : 'lax' // có 3 lựa chọn là strict, lax, none. Strict là sẽ chắc chắn rằng domain của frontend và backend chung 1 tên miền thì cho phép gửi cookies. lax là kiểu cho Cookie được gửi trên cùng một trang web và các yêu cầu GET cấp cao nhất. none là Cookie được gửi trên tất cả các yêu cầu liên trang web
}
